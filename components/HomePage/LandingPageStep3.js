            ...
            <div className="RFC">
              <div className="row">
                ...
                <div className="col-md-5 offset-md-1 mt-2">
                  <Typography className="topPhrase mb-3 mt-2" variant="h4">Create Resume from Professional Templates</Typography>
                ...
                <div className="col-md-5 mt-4">
                  <Typography className="topPhrase mb-3 mt-4" variant="h4">Edit the resume as your like</Typography>
